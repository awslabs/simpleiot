...
#
# SimpleIOT: UI Firmware
# iot_ui_api_model
#
# This is invoked by the dashboard UI to manage firmware generation.
# The GET call returns data needed to generate the request to generate one.
# the actual generate call is sent via POST to the firmware generate URL.
# That will return a fully composited .zip package which can then be downloaded
# or handed off to a build mechanism.
#
